...
#pragma region Private Member Variables
	...
	MAX_DEPRECATED int nv_alloc; //!< \deprecated Deprecated in favor of GetNVAlloc() as of 3dsMax 2024.
	MAX_DEPRECATED int ne_alloc; //!< \deprecated Deprecated in favor of GetNEAlloc() as of 3dsMax 2024.
	MAX_DEPRECATED int nf_alloc; //!< \deprecated Deprecated in favor of GetNFAlloc() as of 3dsMax 2024.
	MAX_DEPRECATED int nm_alloc; //!< \deprecated No longer used as of 3dsMax 2024.
...
//!@}
	...
	MNMap *hmap = nullptr;
	MAX_DEPRECATED MNMap* m; //!< \deprecated No longer used. 3dsMax 2024. Please use M().
...
private:
	...
	\deprecated Deprecated in 3dsMax 2024. Please use GetED().*/
	MAX_DEPRECATED PerData* ed;
	...
	\deprecated Deprecated in 3dsMax 2024. Please use eDataSupport(), setEDataSupport(), EDNum() and EDNumSupported().*/
	MAX_DEPRECATED static BitArray edSupport;
public:
...
private:
	...
	objects are used to store such information as vertex weighting and weighted selections.
	\deprecated Deprecated in 3dsMax 2024. Please use GetVD().*/
	MAX_DEPRECATED PerData* vd;
	...
	\deprecated Deprecated in 3dsMax 2024. Please use vDataSupport(), setVDataSupport(), VDNum() and VDNumSupported().*/
	MAX_DEPRECATED static BitArray vdSupport;
	
	/** \internal
	The number of MNMaps. This member value is owned by the MNVertexColorChannelData and MNTextureMapChannelData channel objects.
	\deprecated Deprecated in 3dsMax 2024. Please use MNum(). */
	MAX_DEPRECATED int numm;
public:
...
private:
	//! Allocates the MNMaps with the specified size.
	//! \deprecated Deprecate as of 3dsMax 2024. Please use SetMapNum() in conjunction with the MN_DEAD flag to achieve the same results.
	MAX_DEPRECATED DllExport void MAlloc (int, bool) {}; //semicolon needed for doxygen
	
	//! Reduces the size of the MNMap data array m to the specified number of elements.
	//! \deprecated Deprecate as of 3dsMax 2024. Please use SetMapNum() in conjunction with the MN_DEAD flag to achieve the same results.
	MAX_DEPRECATED DllExport void MShrink (int) {}; //semicolon needed for doxygen
public:

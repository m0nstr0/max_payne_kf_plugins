...
namespace MaxSDK
{
	...
	* \endcode
	*/
	template<typename T> class [[nodiscard]] VariableGuard : MaxSDK::Util::Noncopyable
	{
	public:
		...
		*/
		VariableGuard(T& variable) :
				...
				*/
				...
				/*! \brief Retrieves the original value of the guarded variable 
				*/
				...
				/*! \brief Restores the variable to its original value
				* Note that the variable will be restored again to its original value when the object instance goes out of scope.
				*/
				void RestoreValue()
				{

...
class IGameControl: public MaxHeapOperators
{
	...
	*/
		...
		*/
		...
		/*! The number of subcontroller tracks maintained by the Point Controller Container. This is NOT actual number of
		subcontrollers, but total number of vertices
		\return The number of subcontroller tracks in the Point Controller Container, zero if no vertex animation
		*/
		virtual int GetNumOfVertControls()=0;

		//! Access the n'th subcontroller from the Point Controller Container
		/*! Access the n'th subcontroller from the Point Controller Container.
		\param index The index into the Point Controller Container, the actual vertex index

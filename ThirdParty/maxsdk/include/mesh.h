...
private:
	...
	*/
	MaxSDK::MeshChannelContainer m_ChannelDataContainer;
		...
		MAX_DEPRECATED int  numVisEdges; //!< \deprecated Deprecated as of 2024. Please use GetNumVisEdges().
		MAX_DEPRECATED int edgeListHasAll; //!< \deprecated Deprecated as of 2024. Please use GetEdgeListHasAll() and SetEdgeListHasAll().
		MAX_DEPRECATED VEdge* visEdge; //!< \deprecated Deprecated as of 2024. Please use GetVisEdge().
...
private:
		...
		this mesh. If the bit is set the channel is supported. Do not manipulate this directly.
		\deprecated Deprecated as of 2024. Please use: getNumVData(), getNumVDataSupported(), vDataSupport(), setVDataSupport()
		*/
		MAX_DEPRECATED static BitArray vdSupport;
		...
		\deprecated Deprecated as of 2024. Please use GetVD(int).
		*/
		MAX_DEPRECATED PerData* vData;

		/*! Indicates the selected vertices. There is one bit for each vertex. Bits that
			are 1 indicate the vertex is selected. Deprecated in favor of VertSel().
		\deprecated Deprecated as of 2024. Please use VertSel().
		*/
		MAX_DEPRECATED static BitArray vertSel;
		
		/*! Indicates the selected faces. There is one bit for each face. Bits that are 1
			indicate the face is selected.
		\deprecated Deprecated as of 2024. Please use FaceSel().
		*/
		MAX_DEPRECATED static BitArray faceSel;
		...
		/*! Indicates the selected edges. There is one bit for each edge of each face. Bits
			...
			3*faceIndex + edgeIndex.
		\deprecated Deprecated as of 2024. Please use EdgeSel().
		*/
		MAX_DEPRECATED static BitArray edgeSel;

		/*! Hidden flags for vertices.
		\deprecated Deprecated as of 2024. Please use VertHide().
		*/
		MAX_DEPRECATED static BitArray vertHide;
public:
...
private:
		...
		\deprecated Deprecated as of 3dsMax 2024. Please use GetMtlIndex() and SetMtlIndex() instead.
		\see Mesh::GetMtlIndex() const;
		\see Mesh::SetMtlIndex(MtlID mtlIndex);
		*/
		MAX_DEPRECATED MtlID mtlIndex;

		/*! The number of maps supported by the mesh.
		\deprecated Deprecated as of 3dsMax 2024. Please use getNumMaps() instead.
		\see Mesh::getNumMaps() const;
		\see MaxSDK::MeshVertexColorChannelData
		\see MaxSDK::MeshTextureMapChannelData
		*/
		MAX_DEPRECATED int numMaps; //Deprecated as of 2024. Please use getNumMaps().

		/*! The number of maps supported by the mesh.
		\deprecated Deprecated as of 3dsMax 2024. Please use Map() instead to access the maps.
		\see Mesh::Map(int mp) const;
		\see MaxSDK::MeshVertexColorChannelData
		\see MaxSDK::MeshTextureMapChannelData
		*/
		MAX_DEPRECATED MeshMap* maps;
public:
...
private:
		//!< \deprecated Deprtecated as of 3dsMax 2024.
		MAX_DEPRECATED DllExport void ZeroTopologyCache() {}
public:
		//! @}

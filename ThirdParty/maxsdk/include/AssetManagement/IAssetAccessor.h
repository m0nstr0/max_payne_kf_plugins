...
public:
	...
	//! \brief This overload was added to allow passing temporary variable to DeclareAsset
	void DeclareAsset(IAssetAccessor&& anAccessor) { DeclareAsset(anAccessor); }
	...
	//! \brief This overload was added to allow passing temporary variable to DeclareAsset
	void DeclareGroup(IAssetAccessor&& anAccessor) { DeclareGroup(anAccessor); }

...
{
	public:
	/*! \remarks This method initializes the Rollup settings. */
...
class ICatRegistry2 : public ICatRegistry
{
public:
	// This method gets the category (order field) for the given SuperClass ID, ClassID and Rollup Title
	/*! \remarks This method gets the category (order field) for the given
	...
	of -1000, that means the entry was not found. 
	<b>boolean open</b>\n\n
	Optional pointer to a boolean receiving the open/close state of the rollup.  
	If the open/close value was not stored, it does not modify the boolean.\n\n	*/
	virtual int GetCat(SClass_ID sid, Class_ID cid, const MCHAR* title, int category, bool* open ) = 0;
	// This method updates (sets) the category (order field) for the given SuperClass ID, ClassID and Rollup Title
	/*! \remarks This method updates (sets) the category (order field) for the
	given SuperClass ID, ClassID and Rollup Title
	\par Parameters:
	...
	The category. 
	<b>boolean open</b>\n\n
	The open/close state of the rollup. */
	virtual void UpdateCat(SClass_ID sid, Class_ID cid, const MCHAR* title, int category, bool open) = 0;
};

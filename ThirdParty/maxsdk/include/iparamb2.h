...
public:
	...
	*/
	...
	//! \note This method has been deprecated in terms of implementation as of 3ds Max 2022. Plugin developers should implement GetLocalName(ReferenceMaker* owner, ParamID id, int tabIndex, bool localized) instead.
	...
	//! \sa PBAccessor::GetLocalName(ReferenceMaker* owner, ParamID id, int tabIndex, bool localized)
#pragma warning(push)
#pragma warning(disable : 4481)
	MAX_DEPRECATED virtual MSTR GetLocalName(ReferenceMaker* owner, ParamID id, int tabIndex) MAX_SEALED
	{

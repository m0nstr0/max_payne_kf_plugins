 ...
 **********************************************************************/
//! TODO: Remove this file from the public SDK 
...
class GenericHierarchy: public MaxHeapOperators {
	...
	public:
		...
		UtilExport HierarchyEntry* GetStart() const { return root.child; } // Get the first item under the root
		...
		UtilExport GenericHierarchy& operator=(const GenericHierarchy& from);	// Copy operator

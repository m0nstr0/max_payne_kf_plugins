...
/// @{
		...
		//! \note This method has been deprecated in terms of implementation as of 3ds Max 2022. Plugin developers should implement GetTexChannelName(long nTextureChan, bool localized) instead.
		...
		//! \sa BaseShader::GetTexChannelName(long nTextureChan, bool localized)
#pragma warning(push)
#pragma warning(disable : 4481)
		MAX_DEPRECATED virtual MSTR GetTexChannelName(long nTextureChan) MAX_SEALED
		{
			return GetTexChannelName(nTextureChan, true);
		}
#pragma warning(pop)

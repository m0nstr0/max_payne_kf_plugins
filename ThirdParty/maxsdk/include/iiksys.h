...
//parameters below are in the first pop-up dialog box "Spline IK SOlver"
  ...
  float TwistHStartAngle(TimeValue t) { Interval valid = FOREVER; return TwistHStartAngle(t, valid); }
  virtual float		TwistHEndAngle(TimeValue, Interval&)=0;
  float TwistHEndAngle(TimeValue t) { Interval valid = FOREVER; return TwistHEndAngle(t, valid); }
  ...
  float SwivelAngle(TimeValue t) { Interval valid = FOREVER; return SwivelAngle(t, valid); }
...
//
/*! \sa  Class INode,
Class Control, Class Point2,  Class Point3,  Class Interval, ~{ Inverse Kinematics }~\n\n
\par Description:
...
public:
  ...
  */
  ...
  virtual INode*	GetNode() const =0;
  /*! \remarks This method allows you to retrieve the preferred position of
  translation. 
  \param t - The time at which to retrieve the preferred position.
  \param validityInterval - The interval into which the validity of the evaluated parameters is intersected.
  \return  The X, Y, and Z, preferred position. */
  ...
  rotation. 
  \par Parameters:
  \param t - The time at which to retrieve the preferred angle.\n\n
  \param validityInterval - The interval into which the validity of the evaluated parameters is intersected.

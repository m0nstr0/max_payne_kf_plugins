...
public:
	...
	/code
		// this code is not within a SaveEnum implementation, so the save ref hierarchy has not already been created
	...
	*/
	...
	//! \brief Method to validate that ReferenceSaveManager data is cleared on all ReferenceMakers in scene. Used internally.
	CoreExport static bool ValidateAllReferenceSaveManagerDataCleared();

		...
		*/
		...
		public:
			...
			enum Direction
			{
				...
				Direction_In = 0x1, // accepts only uni-directional connections : other OUT -> this IN
				Direction_Out = 0x2, // accepts only uni-directional connections : this OUT -> other IN
				Direction_Both = 0x3, // accepts uni- and bi-directional connections
			};

...
private:
	...
	PFExport static const PCU_channelIndex InterfaceID2readIndex(const Interface_ID& id);
	PFExport static const PCU_channelIndex InterfaceID2writeIndex(const Interface_ID& id);

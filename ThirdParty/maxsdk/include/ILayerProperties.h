...
public:
	...
	virtual	ILayerProperties*	newLayer	()			=	0;
	...
	virtual ILayerProperties*	getCurrent	()		=	0;
};
...
public:
	...
	virtual	BOOL	getNeverDegrade	()				=	0;

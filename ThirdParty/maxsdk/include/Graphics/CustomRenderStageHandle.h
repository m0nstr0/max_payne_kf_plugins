...
public:
	...
	*/
	...
	/** Set the override material to the custom render stage
		...
		\note This call will replace any previously set override effect instance handle
	*/
	...
	*/
	...
	/** Get the override effect instance handle of the custom render stage
		\return the effect instance handle
	*/
	...
	/** Set the override effect instance handle to the custom render stage
		\param[in] effectInstanceHandle the override effect instance handle
		\note This call will replace any previously set override material.
		\note Using an override effect instance handle instead of an override material will let you load from the resource a compiled HLSL shader 
		and use GPU debuggers. Use EffectHandle::InitializeWithResource to load a compiled shader from the resource file.
	*/

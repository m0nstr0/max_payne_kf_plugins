...
public:
	...
	*/
	GEOMEXPORT bool Contains(const IPoint2& p) const; // is point in this box?
...
struct FBox2
{
	...
	GEOMEXPORT bool Contains(const Point2& p) const; // is point in this box?
};

...
struct is_container_element_type_compatible<T, E,
		typename std::enable_if<!std::is_same<typename std::remove_cv<decltype(detail::data(std::declval<T>()))>::type,
				void>::value>::type>
...
class tuple_size<geo::span<ElementType, Extent>> : public integral_constant<size_t, Extent>
{
};

template <typename ElementType>
class tuple_size<geo::span<ElementType, geo::dynamic_extent>>; // not defined

template <size_t I, typename ElementType, size_t Extent>
class tuple_element<I, geo::span<ElementType, Extent>>
{
public:
	static_assert(Extent != geo::dynamic_extent && I < Extent, "");

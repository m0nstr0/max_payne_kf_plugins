...
public:
	...
	GEOMEXPORT void IncludePoints(const Point3* pts, int numpoints, Matrix3* tm = nullptr);
	...
	GEOMEXPORT bool IsEmpty() const; // is this box empty?
	...
	GEOMEXPORT bool IsInitialized() const; // is this box initialized?
	...
	otherwise false. */
	GEOMEXPORT bool Contains(const Point3& p) const; // is point in this box?
	...
	\par Operators:
	*/
	GEOMEXPORT bool Contains(const Box3& b) const; // is box b totally in this box?
	...
	\par Operators:
	*/
	GEOMEXPORT bool Intersects(const Box3& b) const; // does box b intersect this box at all?
	...
	*/
	GEOMEXPORT bool TriBoxOverlap(const Point3 vert0, const Point3 vert1,

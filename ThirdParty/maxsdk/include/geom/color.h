...
public:
	...
	GEOMEXPORT /*explicit*/ Color(const AColor& c);
	GEOMEXPORT /*explicit*/ Color(AColor&& c);
	...
	GEOMEXPORT explicit Color(uint32_t rgb); // from Windows RGB value
	...
	GEOMEXPORT operator RealPixel() const;

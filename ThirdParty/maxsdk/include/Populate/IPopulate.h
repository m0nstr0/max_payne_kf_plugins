		...
		*/
		class IPopulate : public  FPStaticInterface
		{
		  public:
			...
			//! \name Characters
			///@{
			//! \brief Returns the display type of the characters
			...
			//! \name Simulation
			///@{
			/*! \brief Returns the number of frames to simulate */
			...
			///@{
			/*! \brief Returns the custom material for custom skinned characters */

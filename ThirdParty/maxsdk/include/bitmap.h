...
class bmmHistoryList: public MaxHeapOperators
{
	protected:
		MSTR m_title;
		MSTR m_initDir;
		//! \deprecated This has been deprecated as of 3ds Max 2024, please use m_title instead
		MAX_DEPRECATED static MCHAR title[MAX_PATH];
		//! \deprecated This has been deprecated as of 3ds Max 2024, please use m_initDir instead
		MAX_DEPRECATED static MCHAR initDir[MAX_PATH];
...
class BMM_IOHandler : public MaxHeapOperators 
{
   private:
	  ...
	  MSTR m_ioShortDesc;
	  MSTR m_ioLongDesc;
	  //! \deprecated This has been deprecated as of 3ds Max 2024, please use m_ioShortDesc instead
	  MAX_DEPRECATED static MCHAR ioShortDesc[MAX_DESCRIPTION];
	  //! \deprecated This has been deprecated as of 3ds Max 2024, please use m_ioLongDesc instead
	  MAX_DEPRECATED static MCHAR ioLongDesc[MAX_DESCRIPTION];
...
private:
		...
		MSTR m_device;
		//! \deprecated This has been deprecated as of 3ds Max 2024, please use m_device instead
		MAX_DEPRECATED static MCHAR device[MAX_DESCRIPTION];
...
//! @{
	  ...
	  //! \deprecated This has been deprecated as of 3ds Max 2024, please use MSTR& overload instead
	  MAX_DEPRECATED virtual void EvalMatch(MCHAR* matchString) final { matchString[0] = 0; }
//! @}
...
class BitmapStorage : public BaseInterfaceServer
{
   ...
   public:
	  ...
	  BitmapInfo bi;
	  MSTR m_evalString;
	  //! \deprecated This has been deprecated as of 3ds Max 2024, please use m_evalString instead
	  MAX_DEPRECATED static MCHAR* evalString;

...
#define GetCATICATParentRootFPInterface(anim)  (anim ? ((CatAPI::ICATParent*)anim->GetInterface(CatAPI::CATPARENT_INTERFACE_FP)) : nullptr)
	...
	public:
		...
		/// \param filename The file to save the rig too.  This can
		...
		/// \param mode the current CATMode
		/// \param skipUIInvalidate 
		virtual void	SetCATMode(CATMode mode, bool skipUIInvalidate = false) = 0;

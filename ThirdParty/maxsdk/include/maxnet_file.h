...
public:
	...
	bool	LocateSection	(const MCHAR* section);
	MCHAR*	LocateValue		(const MCHAR* section, const MCHAR* var, bool rescan = true);
	MCHAR*	GetLine			(MCHAR* destination = 0 );

	bool	ReadFilename	(MCHAR* ptr, MCHAR* filename);

	bool	Write			(const MCHAR* line);
	bool	WriteHeader		(const MCHAR* hdr);
	bool	WritePair		(const MCHAR* var, float value);
	bool	WritePair		(const MCHAR* var, int value);
	bool	WritePair		(const MCHAR* var, bool value);
	bool	WritePair		(const MCHAR* var, short value);
	bool	WritePair		(const MCHAR* var, DWORD value);
	bool	WritePair		(const MCHAR* var, size_t value);
	bool	WritePair		(const MCHAR* var, MCHAR* value);
	bool	WritePair		(const MCHAR* var, SYSTEMTIME* value);
	bool	WritePairHex	(const MCHAR* var, DWORD value);

	bool	ReadPair		(const MCHAR* section, const MCHAR* var, float* value);
	bool	ReadPair		(const MCHAR* section, const MCHAR* var, int* value);
	bool	ReadPair		(const MCHAR* section, const MCHAR* var, bool* value);
	bool	ReadPair		(const MCHAR* section, const MCHAR* var, short* value);
	bool	ReadPair		(const MCHAR* section, const MCHAR* var, DWORD* value);
	bool	ReadPair		(const MCHAR* section, const MCHAR* var, size_t* value);
	bool	ReadPair		(const MCHAR* section, const MCHAR* var, MCHAR* value);
	bool	ReadPair		(const MCHAR* section, const MCHAR* var, SYSTEMTIME* value);
	bool	ReadPairHex		(const MCHAR* section, const MCHAR* var, DWORD* value);
};

...
//! \name Description/Copyright/Author/Version
//! @{	  
	  //-- Filter Info    ---------------------------------
...
/** \name Parameter Block Configuration Data
...
//! \name Filter Control Dialog Interactivity
//! @{

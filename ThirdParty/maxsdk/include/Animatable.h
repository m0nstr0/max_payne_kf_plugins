...
/// @{
		//! \note This method has been deprecated in terms of implementation as of 3ds Max 2022. Plugin developers should implement GetClassName(MSTR& s, bool localized) const instead.
		...
		//! \sa Animatable::GetClassName(MSTR& s, bool localized) const
#pragma warning(push)
#pragma warning(disable : 4481)
		MAX_DEPRECATED virtual void GetClassName(MSTR& s) MAX_SEALED
		{
			GetClassName(s, true);
		}
#pragma warning(pop)
...
//! @{
		...
		//! \note This method has been deprecated in terms of implementation as of 3ds Max 2022. Plugin developers should implement SubAnimName(int i, bool localized) instead.
		//!       This method can no longer be overriden and calls to it are now forwarded to the function that replaced it with a "bool localized" value of true.
		//!       This is done so that plugin developers who do not localize their plugins don't have to update all the places where they call this method.
		//!       Plugin developers who do localize their plugins should analyze the places where they call this method to decide what value to pass it for the "bool localized" parameter.
		//! \sa Animatable::SubAnimName(int i, bool localized)
#pragma warning(push)
#pragma warning(disable : 4481)
		MAX_DEPRECATED virtual MSTR SubAnimName(int i) MAX_SEALED
		{
			return SubAnimName(i, true);
		};
#pragma warning(pop)

...
public:
    ...
    void Update(const TimeValue t, INode* const cameraNode, const IPoint2& renderResolution, const float pixelAspectRatio, Interval&& valid = FOREVER)
    {
        Update(t, cameraNode, renderResolution, pixelAspectRatio, valid);
    }

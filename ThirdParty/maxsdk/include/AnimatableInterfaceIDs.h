...
#define I_DRIVER			0x00001060 //!< An Animatable supporting this interface is a ReferenceTarget
...
#define I_BUFFERABLE		0x000013e0	//!< An Animatable supporting this interface is an IBufferable
#define I_TANGENT			0x000013f0 //!< An Animatable supporting this interface is an IAdjustTangents
...
#define GetDriverController(anim) ((ReferenceTarget*)(anim)->GetInterface(I_DRIVER))

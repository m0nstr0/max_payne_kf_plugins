...
/*! \name Paramblock2 flags */
//!@{
//! \brief  Set when a Paramblock2 has added itself to the PostLoadCallback used so we dont add multiple copies to the array
...
//!@{
//! \brief Animatable is being used in a scene file save and is locked.
/*! If Animatable is a ReferenceTarget, it will not be deleted when dependents goes to 0 if this flag is set. The
ReferenceTarget in this case will be deleted at the end of the file save process when MaybeAutoDelete() is called on it.
*/

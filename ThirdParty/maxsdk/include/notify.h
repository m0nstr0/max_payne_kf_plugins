...
//! \deprecated Deprecated as of 3ds Max 2022, use NOTIFY_FILE_POST_MERGE3 instead.
#define NOTIFY_FILE_POST_MERGE			0x0000000C
#pragma deprecated("NOTIFY_FILE_POST_MERGE")
...
//! \brief Sent after a file is merged successfully - right after NOTIFY_FILE_POST_MERGE.
/* NotifyInfo::callParam is a pointer to NotifyPostMerge2Param.*/
//! \deprecated Deprecated as of 3ds Max 2022, use NOTIFY_FILE_POST_MERGE3 instead.
#define NOTIFY_FILE_POST_MERGE2			0x000000FB
#pragma deprecated("NOTIFY_FILE_POST_MERGE2")
...
//! \deprecated This message was deprecated in Max 2022. Please use NOTIFY_PRE_ACTIVESHADE_IN_VIEWPORT_TOGGLED 
//! and NOTIFY_POST_ACTIVESHADE_IN_VIEWPORT_TOGGLED
#define NOTIFY_ACTIVESHADE_IN_VIEWPORT_TOGGLED          0x00000107
#pragma deprecated("NOTIFY_ACTIVESHADE_IN_VIEWPORT_TOGGLED")
...
//! \brief Sent after a file is merged successfully - right after NOTIFY_FILE_POST_MERGE2.
/* NotifyInfo::callParam is a pointer to NotifyPostMerge3Param.*/
#define NOTIFY_FILE_POST_MERGE3          0x0000010B
...
#define NOTIFY_ACTIVESHADE_IN_FRAMEBUFFER_TOGGLED          0x0000010C
...
#define NOTIFY_PRE_ACTIVESHADE_IN_VIEWPORT_TOGGLED          0x0000010D
...
//! Please note that toggling ActiveShade in the frame buffer generates a different notification, namely NOTIFY_ACTIVESHADE_IN_FRAMEBUFFER_TOGGLED
#define NOTIFY_POST_ACTIVESHADE_IN_VIEWPORT_TOGGLED          0x0000010E
...
//! changed.
#define NOTIFY_COLOR_MANAGEMENT_POST_CHANGE 0x00000110
...
//! \brief The call parameter that accompanies the notification code \ref NOTIFY_FILE_POST_OPEN
...
//! \brief The call parameter that accompanies the notification code \ref NOTIFY_FILE_POST_MERGE2
//! \deprecated Deprecated as of 3ds Max 2022, use NotifyPostMerge3Param instead. 
struct MAX_DEPRECATED NotifyPostMerge2Param : public MaxHeapOperators
{
	//! \brief fileSaveVersion stores the result of ILoad::GetFileSaveVersion()
	DWORD fileSaveVersion{ 0 };
	//! \brief fileSaveAsVersion stores the result of ILoad::FileSaveAsVersion()
...
//! \brief The call parameter that accompanies the notification code \ref NOTIFY_FILE_POST_MERGE3
...
// \ref NOTIFY_FILE_PRE_OPEN_PROCESS, \ref NOTIFY_FILE_POST_OPEN_PROCESS,
// \ref NOTIFY_FILE_PRE_SAVE_PROCESS, \ref NOTIFY_FILE_POST_SAVE_PROCESS
...
//! \brief The call parameter that accompanies the notification codes
// \ref NOTIFY_PRE_MODIFIER_ADDED, NOTIFY_POST_MODIFIER_ADDED, 
// \ref NOTIFY_PRE_MODIFIER_DELETED, NOTIFY_POST_MODIFIER_DELETED

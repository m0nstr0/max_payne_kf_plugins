...
template <class T> class NoExport Tab: public MaxHeapOperators 
{
	...
	public:
		...
		*/
		...
		//! \brief Retrieves the number of items in the Tab. Standard compliant.
		...
		*/
		...
		//!	\brief Returns a pointer to the data buffer of tab. Standard compliant.
		/*! \return A pointer to the tab data buffer.
		 */
		...
		//!	\brief Returns a const pointer to the data buffer of tab. Standard compliant.
		/*! \return A const pointer to the tab data buffer.
		 */

...
public:
	...
	// From Animatable
	SClass_ID SuperClassID() override { return kLayerManagerSuperClassID; }
	...
	virtual ILayer * CreateLayer(const MSTR& name) = 0;
	...
	*/
	...
	virtual int GetPropagateToLayer() = 0;
};
...
public:
	...
	\return the number of layers deleted. */
	virtual int DeleteLayerHierarchy(ILayer* layer, bool forceDelete = false) = 0;

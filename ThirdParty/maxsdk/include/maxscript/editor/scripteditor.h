...
class ScriptEditor
{
	...
	public:
		...
		ScripterExport virtual	HWND	DisplayWindow(HWND hParent=nullptr/*for future use*/);
		...
		virtual Value*	GetValueTitle()		{ return (ew) ? ew->file_name : nullptr; }
		//! return false to default handling
		virtual bool	OnExecute(HWND hwnd){ UNUSED_PARAM(hwnd); return false; } 
		virtual	bool	IsDisplayed()		{ return ew!=nullptr; }

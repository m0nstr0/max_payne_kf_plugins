...
extern ScripterExport MAXSuperClass point4_controller;
...
extern ScripterExport MAXSuperClass driver_block_controller; 
...
extern ScripterExport MAXSuperClass commonBakeMap_class;
extern ScripterExport MAXSuperClass commonBakeMapOperator_class;
...
extern Value*  stdtex_get_enableColorMap(ReferenceTarget* obj, Value* prop, TimeValue t, Interval& valid);
extern void    stdtex_set_enableColorMap(ReferenceTarget* obj, Value* prop, TimeValue t, Value* val);
extern Value*  stdtex_get_useRGBColorMap(ReferenceTarget* obj, Value* prop, TimeValue t, Interval& valid);
extern void    stdtex_set_useRGBColorMap(ReferenceTarget* obj, Value* prop, TimeValue t, Value* val);
...
extern Value*  shape_get_twist_correction(ReferenceTarget* obj, Value* prop, TimeValue t, Interval& valid);
extern void    shape_set_twist_correction(ReferenceTarget* obj, Value* prop, TimeValue t, Value* val);
extern Value*  shape_get_cap(ReferenceTarget* obj, Value* prop, TimeValue t, Interval& valid);
extern void    shape_set_cap(ReferenceTarget* obj, Value* prop, TimeValue t, Value* val);
extern Value*  shape_get_quad_cap(ReferenceTarget* obj, Value* prop, TimeValue t, Interval& valid);
extern void    shape_set_quad_cap(ReferenceTarget* obj, Value* prop, TimeValue t, Value* val);
extern Value*  shape_get_sphere_cap(ReferenceTarget* obj, Value* prop, TimeValue t, Interval& valid);
extern void    shape_set_sphere_cap(ReferenceTarget* obj, Value* prop, TimeValue t, Value* val);
extern Value*  shape_get_cap_segments(ReferenceTarget* obj, Value* prop, TimeValue t, Interval& valid);
extern void    shape_set_cap_segments(ReferenceTarget* obj, Value* prop, TimeValue t, Value* val);

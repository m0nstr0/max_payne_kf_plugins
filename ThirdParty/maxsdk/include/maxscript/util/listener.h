/*		Listener.h - the Listener class - Scripting Listener windows
 *
...
using msg_output_callback = void (*)(const MCHAR* x);
...
public:
	...
	Class_ID ClassID() const override { return Class_ID(0x7c953dee, 0x3b446511);}
};

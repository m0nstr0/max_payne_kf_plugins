...
#pragma warning(disable:4100)
	...
	def_visible_primitive			( forceReloadBitmapFile, "forceReloadBitmapFile");
	def_visible_primitive			( registerFileChangedFunction, "registerFileChangedFunction");
...
//	def_visible_generic				( perspectiveMatch, "perspectiveMatch" ); 
	...
	def_visible_generic				( validateColorSpace,"validateColorSpace" );
	def_visible_generic				( colorConvert,		"colorConvert" );
	def_visible_generic				( setOutputColorConversion, "setOutputColorConversion" );

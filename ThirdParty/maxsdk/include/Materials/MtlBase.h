...
//! @{			
			...
			//! \note This method has been deprecated in terms of implementation as of 3ds Max 2022. Plugin developers should implement GetFullName(bool localized) instead.
			...
			//! \sa MtlBase::GetFullName(bool localized)
#pragma warning(push)
#pragma warning(disable : 4481)
			MAX_DEPRECATED virtual MSTR GetFullName() MAX_SEALED
			{

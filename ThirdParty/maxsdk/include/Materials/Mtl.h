...
/** \name Naming Methods */
//! @{
	//! \note This method has been deprecated in terms of implementation as of 3ds Max 2022. Plugin developers should implement GetSubMtlSlotName(int i, bool localized) instead.
	...
	//! \sa Mtl::GetSubMtlSlotName(int i, bool localized)
#pragma warning(push)
#pragma warning(disable : 4481)
	MAX_DEPRECATED virtual MSTR GetSubMtlSlotName(int i) MAX_SEALED
	{
		return GetSubMtlSlotName(i, true);
	}
#pragma warning(pop)

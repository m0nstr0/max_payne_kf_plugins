...
public:
	...
	//! \note This method has been deprecated in terms of implementation as of 3ds Max 2022. Plugin developers should implement GetSubTexmapSlotName(int i, bool localized) instead.
	...
	//! \sa ISubMap::GetSubTexmapSlotName(int i, bool localized)
#pragma warning(push)
#pragma warning(disable : 4481)
	MAX_DEPRECATED virtual MSTR GetSubTexmapSlotName(int i) MAX_SEALED
	{
		return GetSubTexmapSlotName(i, true);
	};
#pragma warning(pop)

...
#pragma deprecated("TRI_MULTI_PROCESSING") // No longer used. 3dsMax 2024
...
//#if TRI_MULTI_PROCESSING
		MAX_DEPRECATED static int		refCount; // No longer used. 3dsMax 2024
		MAX_DEPRECATED static HANDLE	defThread; // No longer used. 3dsMax 2024
		MAX_DEPRECATED static HANDLE	defMutex; // No longer used. 3dsMax 2024
		MAX_DEPRECATED static HANDLE	defStartEvent; // No longer used. 3dsMax 2024
		MAX_DEPRECATED static HANDLE	defEndEvent; // No longer used. 3dsMax 2024
//#endif	

...
/// @{
	...
	//! \note This method has been deprecated in terms of implementation as of 3ds Max 2022. Plugin developers should implement GetObjectName(bool localized) const instead.
	...
	//! \sa BaseObject::GetObjectName(bool localized) const
#pragma warning(push)
#pragma warning(disable : 4481)
	MAX_DEPRECATED virtual const MCHAR *GetObjectName() MAX_SEALED
	{
...
public:
	...
	//!       This is done so that plugin developers who do not localize their plugins don't have to update all the places where they call this method.
	//!       Plugin developers who do localize their plugins should analyze the places where they call this method to decide what value to pass it for the "bool localized" parameter.
	//! \sa Modifier::GetName(bool localized) const
#pragma warning(push)
#pragma warning(disable : 4481)
	MAX_DEPRECATED virtual MSTR GetName() MAX_SEALED
	{
		return GetName(true);
	}
#pragma warning(pop)

...
//! \brief Interface into the biped driver controller for Max 11.
/*! This contains functions supporting new biped features in Max 11.
*/
class IBipDriver11 : public IBipDriver10
{
	public:
	...
	*/
//!@{
		static constexpr ULONG I_BIPDRIVER11 = 0x9171;    //!< Biped interface identifier

		//! \brief Gets the Biped interface
		//! \param[in]  anim - the Animatable whose Biped interface is returned
		//! \return the Biped interface
		BIPExport static IBipDriver11* GetBipDriver11Interface(Animatable& anim); //!< Gets the Biped interface
//!@}*/

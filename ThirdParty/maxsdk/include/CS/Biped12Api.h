...
//! \brief Interface into the biped driver controller.
/*! This contains functions supporting new biped features.
*/
class IBipDriver12 : public IBipDriver11
{
	public:
	...
	*/
//!@{
		static constexpr ULONG I_BIPDRIVER12 = 0x9172;    //!< Biped interface identifier

		//! \brief Gets the Biped interface
		//! \param[in]  anim - the Animatable whose Biped interface is returned
		//! \return the Biped interface
		BIPExport static IBipDriver12* GetBipDriver12Interface(Animatable& anim);
//!@}*/

...
*/
//!@{
#define I_BIPDRIVER8	0x9167    //!< Biped interface identifier
#define GetBipDriver8Interface(anim) ((IBipDriver8*)(anim)->GetInterface(I_BIPDRIVER8))	//!< Gets the Biped interface
//!@}
...
functions of IBipDriver, and retrieved from the GetActiveModes function of IBipDriver.
...
An instance of ICopyCollection can be gotten from the IBipDriver8 GetCopyCollection and CreateCopyCollection functions.
*/
...
//! \brief Interface into the biped driver controller for Max 8.
...
*/
class IBipDriver8 : public IBipDriver
{
	public:

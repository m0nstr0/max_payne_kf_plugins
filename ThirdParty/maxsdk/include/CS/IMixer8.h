...
public:
	...
	//! \param[in] collapse If TRUE the mixer will collapse and replace the mixer driven controllers with
	//! the values set in the mixer, otherwise it will replace the driven with the original controllers

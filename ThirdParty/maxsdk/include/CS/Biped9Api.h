...
*/
//!@{
#define I_BIPDRIVER9	0x9168    //!< Biped interface identifier
#define GetBipDriver9Interface(anim) ((IBipDriver9*)(anim)->GetInterface(I_BIPDRIVER9))	//!< Gets the Biped interface
//!@}

//! \brief Interface into the biped driver controller for Max 9.
...
an XAF file.
*/
class IBipDriver9 : public IBipDriver8
{
	public:
	...
	*/
	...
	//! \param[in] id The internal 'id' of the biped node.  You get this by calling IBipDriver::GetIdLink.
	//! \param[in] link The internal 'link' of the biped node.  You get this by calling IBipDriver::GetIdLink.
